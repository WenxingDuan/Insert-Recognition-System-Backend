...
def set_pretrained_model(model_name, model102=True, frozen=True):
    ...
    if (model_name == "vgg16" and frozen):
...
def set_model_classifier(model,
                         hidden_layer,
                         input_size=25088,
                         output_size=10,
                         dropout=0.5):  #改
    ...
    for epoch in range(epochs):
        ...
        for inputs, labels in trainloader:
            ...
            if steps % print_every == 0:
                ...
                evaluation_metrics = [
                    (choosen_architecture + "_Train loss",
                     running_loss_it / print_every),
                    (choosen_architecture + "_Validation loss",
                     validloss / len(validloader)),
                    (choosen_architecture + "_Validation accuracy",
